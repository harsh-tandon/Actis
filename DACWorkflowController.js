    ...
    $scope.GetFollowupTextForQuestionId = function (QuestionId, LinkQuestionId, responseType) {
        ...
        if ($scope.AllifAssetName.toUpperCase() == $("#allifClass").val().toUpperCase()) {
            if ( responseType.toUpperCase() == 'YES') {
                ...
                //$("#yesFollowUp_" + QuestionId).css('display','');
                //$("#noFollowUp_" + QuestionId).css('display','none');
                //$("#yesFollowUp_" + QuestionId).prop('checked', true) &&
                //$("#yesFollowUp_" + QuestionId).removeClass('YesFollowupHide');
                //$("#yesFollowUp_" + QuestionId).addClass('YesFollowupShow');
                ...
                //$("#noFollowUp_" + QuestionId).css('display', '');
                //$("#noFollowUp_" + QuestionId).prop('checked', true) && 
                //var Id = "#noFollowUp_" + QuestionId;
                //$(Id).removeClass("NoFollowupHide");
                // $(Id).addClass("NoFollowupShow");
                ...
                ($("#yesFollowUp_" + QuestionId).prop('checked', true) || $("#noFollowUp_" + QuestionId).prop('checked', true)))
            {
                ...
                //    }
                //}
                //console.log('Array length ' + $scope.LinkedQuestionValueArray.length)
                ////Link Question ID to hold
                //if (ItemExists == false) {
                ...
                //    $scope.LinkedQuestionValueArray.push({ 'LinkQid': LinkQuestionId });
                //    console.log('Array length ' + $scope.LinkedQuestionValueArray.length)
                //    console.log('followup Question - b4 - IsPage incremen ' + $scope.isPageIncremented +' Total Questions ' + $scope.TotalQuestions + ' Current Questions ' + $scope.CurrentQuestion)
